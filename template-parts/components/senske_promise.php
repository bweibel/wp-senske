...
<section class="promise column-container entry-content">
	<div class="content column size-5">
		<header class="pull-left">
			<h4 class="subtitle">100% Satisfaction Guaranteed</h4>
	...
	<div class="seal column size-1">
		<img src="<?php echo get_template_directory_uri() . '/assets/images/senske-guarantee-family-owned.png';?>" alt="The Senske Promise: 100% Satisfaction" class="wp-image-2565"  width="300px">
