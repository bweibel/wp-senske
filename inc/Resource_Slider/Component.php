...
class Component implements Component_Interface {
	...
	public function action_register_resourcelist_script() {
		...
		wp_register_script(
			...
			senske()->get_asset_version( get_theme_file_path( '/assets/js/resourcelist.min.js' ) ),
			false
		);
		wp_script_add_data( 'senske-resourcelist', 'async', true );
		wp_script_add_data( 'senske-resourcelist', 'precache', true );
