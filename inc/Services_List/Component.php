...
class Component implements Component_Interface {
	...
	public function action_register_serviceslist_script() {
		...
		wp_register_script(
			...
			senske()->get_asset_version( get_theme_file_path( '/assets/js/serviceslist.min.js' ) ),
			false
		);
		wp_script_add_data( 'senske-serviceslist', 'async', true );
		wp_script_add_data( 'senske-serviceslist', 'precache', true );
